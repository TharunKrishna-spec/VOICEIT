...
import { X, ArrowRight, Edit, Image as ImageIcon } from 'lucide-react';
    ...
    <Section id="departments" className="bg-slate-950 min-h-screen flex flex-col justify-center overflow-hidden relative py-20">
      ...
      {isMobile ? (
        ...
        <div className="relative h-[800px] w-full flex items-center justify-center -mt-24">
             <div className="absolute z-20 w-48 h-48 rounded-full bg-slate-900 border border-slate-700 flex items-center justify-center shadow-[0_0_80px_rgba(255,87,34,0.15)] overflow-hidden">
                 ...
                 <div className="z-10 relative w-full h-full flex items-center justify-center rounded-full overflow-hidden bg-slate-950">
                    {activeLogo ? (
                        ...
                        <div className="flex flex-col items-center justify-center text-slate-500/50 w-full h-full relative">
                            ...
                            <span className="text-[10px] mt-2 font-mono tracking-widest font-bold opacity-60">IMAGE PENDING</span>
                            
                            <motion.div 
                                className="absolute top-0 left-0 w-full h-1 bg-neon-orange/50 shadow-[0_0_15px_#FF5722]"
                                animate={{ top: ['0%', '100%'] }}
            ...
            >
                ...
                >
                    ...
                    <div className="w-full md:w-1/3 bg-gradient-to-br from-slate-900 to-black p-8 flex items-center justify-center relative overflow-hidden">
                        <div className={`absolute inset-0 opacity-20 bg-neon-orange blur-3xl`}></div>
